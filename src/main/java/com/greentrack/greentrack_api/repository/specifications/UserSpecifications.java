        ...
        return (root, query, criteriaBuilder) -> {
            ...
            if (StringUtils.hasText(filter.globalSearch())) {
                ...
                Predicate globalPredicate = criteriaBuilder.or(
                    criteriaBuilder.like(criteriaBuilder.lower(root.get(FIELD_USERNAME)), searchPattern),
                    criteriaBuilder.like(criteriaBuilder.lower(root.get(FIELD_FULLNAME)), searchPattern),
