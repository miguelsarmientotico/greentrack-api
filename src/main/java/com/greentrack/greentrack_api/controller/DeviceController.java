...
public class DeviceController {
  ...
  public ResponseEntity<PagedResponse<DeviceEntity>> getAllDevices(
    ...
    PagedResponse<DeviceEntity> response =
        new PagedResponse<>(
  ...
  public ResponseEntity<DeviceEntity> createDevice(
      @Validated(OnCreate.class) @RequestBody DeviceDTO deviceDTO, Authentication authentication) {
    LOG.info(
        "Usuario '{}' registrando nuevo dispositivo: {}",
  ...
  public ResponseEntity<Void> deleteDevicesBulk(
    ...
    LOG.warn(
        "⚠️ Usuario '{}' solicitó ELIMINACIÓN MASIVA de {} devices.",
        authentication.getName(),
        count);
