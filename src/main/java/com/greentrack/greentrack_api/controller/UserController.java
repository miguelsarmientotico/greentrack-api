...
public class UserController {
    ...
    public ResponseEntity<UserResponseDTO> createUser(
        ...
        LOG.info("👤 Admin '{}' creando NUEVO USUARIO: {} (Email: {})", 
            authentication.getName(), userDTO.getUsername(), userDTO.getEmail());
    ...
    public ResponseEntity<UserResponseDTO> updateUser(
        ...
        LOG.info("🛠️ Admin '{}' modificando perfil de usuario ID: {}", authentication.getName(), userId);
    ...
    public ResponseEntity<Void> deleteUser(
        ...
        LOG.warn("🗑️ Admin '{}' ELIMINANDO permanentemente al usuario ID: {}", authentication.getName(), userId);
    ...
    public ResponseEntity<Void> deleteUsersBulk(
        ...
        LOG.warn("🗑️⚠️ Admin '{}' ejecutó ELIMINACIÓN MASIVA de {} usuarios.", authentication.getName(), count);
